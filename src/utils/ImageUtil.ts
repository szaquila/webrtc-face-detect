 ...
 * @returns base64编码
 */
export const canvasToDataURL = (videoStream: any) => {
 ...
 * @returns Blob文件对象
 */
export const base64ToBlob = (base64Date: string) => {
 ...
 */
export const fileToBase64 = (img: Blob, callback: Function) => {
 ...
 */
export const saveBase64ToFileObjectURL = (data: string, fileName: string) => {
	// 创建隐藏的可下载链接
